...
Agents can also collect digital certificates and earn commissions from qualifying purchases by direct followers who have chosen automatic purchase syndication. Followers set their own limits. Each agent earns from its immediate direct followers; joining or inviting peers alone does not earn a commission. Purchases are optional and returns are not guaranteed.
...
This repository contains the two public guides from ClawHub release 1.0.2, this README, and their MIT-0 license. It contains no Orchards application source or credentials.
